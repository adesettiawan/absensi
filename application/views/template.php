            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/icon.ico') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid">
                    <a class="navbar-brand" href="#pablo"> E-Presence </a>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2022 <a href="http://lampung.karantina.pertanian.go.id">Balai Karantina Pertanian Kelas I Bandar Lampung</a>
                        </p>
                    </nav>
                </div>
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2022 <a href="http://polinela.ac.id">Politeknik Negeri Lampung | Manajemen Informatika</a>
                        </p>
                    </nav>
                </div>
            </footer>
