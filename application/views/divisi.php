    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title float-left">Penempatan</h4>
                <div class="d-inline ml-auto float-right">
                    <a href="#" class="btn btn-success btn-sm btn-add-divisi" data-toggle="modal" data-target="#modal-add-divisi"><i class="fa fa-plus"></i> Tambah Penempatan</a>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('divisi/store') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-add-divisi-label">Tambah Penempatan</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama-divisi">Penempatan :</label>
                        <input type="text" name="nama_divisi" id="nama-divisi" class="form-control" placeholder="Penempatan" required="reuired" />
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-edit-divisi" action="<?= base_url('divisi/update') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-edit-divisi-label">Edit Penempatan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="edit-nama-divisi">Penempatan :</label>
                        <input type="hidden" name="id_divisi" id="edit-id-divisi">
                        <input type="text" name="nama_divisi" id="edit-nama-divisi" class="form-control" placeholder="Penempatan" required="reuired" />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
